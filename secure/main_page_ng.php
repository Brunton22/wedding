			...
			<div class="container_bg">
				<div class="center">
					<div class="header_container">
						<div class="header dark-blue text_center">Alex and Sophie
							...
							<ul class="nav_menu text_center">
								...
								<i class="fa fa-heart" aria-hidden="true"></i></a></a></li>
					...
					<div class="sub_head ow text_center" id="ow">Our Wedding</div>
						<div class="text_center main_info">Saturday August 29th 2015<br>
							8pm<br><br>
							Reception<br><br>
							Springkell<br><br>
							<div class="rsvp_click ow_rsvp page_rsvp">RSVP</div>
						</div><!--<br>-->

					<hr class="page_splitter center"></hr>
					<div class="sub_head text_center" id="pts">Places To Stay</div><!--<br>-->
						<div class="text_center main_info"><a class="pts_link" href="http://www.somertonhotel.co.uk/" target="_blank">The Somerton House Hotel, Lockerbie</a><!--<br><br>-->
					...
					<div class="sub_head location text_center" id="location">Travel and Transportation</div><!--<br>-->
						<div class="travel_info text_center">Springkell<br>Eaglesfield<br>Lockerbie<br>Dumfriesshire<br>Scotland<br>DG11 3AL</div><!--<br>-->
							...
							<div class="bus_info text_center main_info">There will be a Houstons executive coach pickup from The Waterfront Cafe on the Whitesands at 7pm.<br><br>
							...
							The coach will be returning to Dumfries at 1am</div>
